...
export const Route = createFileRoute("/_layout/terms-service")({
  component: Component,
});
  ...
  return (
    <div className="container w-full max-w-4xl mx-auto bg-background text-foreground">
      ...
      <p>
        ...
        our Privacy Policy. We process your data in accordance with the General
      ...
      <p>
        ...
        services. This includes data necessary for account creation, purchases,
        and user interactions. For more details, please review our Privacy
        Policy. You have the right to access, rectify, or delete your data, as
        well as the right to restrict processing, data portability, and the
        right to object.
      </p>

      <h2 className="text-2xl font-bold mt-8 mb-4">4. Use of the Platform</h2>
      <ul className="list-disc list-inside">
        <li>
      ...
      <h2 className="text-2xl font-bold mt-8 mb-4">10. Amendments</h2>
      <p>
      ...
      <p>
        These Terms are governed by the laws of Portugal and comply with the
        GDPR. Any disputes will be resolved exclusively in the courts of
        Portugal.
      </p>

      <h2 className="text-2xl font-bold mt-8 mb-4">12. Contact Us</h2>
      <p>
        For any questions about these Terms, including data protection
